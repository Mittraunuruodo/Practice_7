...
var style_2_2 = function(feature, resolution){
    ...
    if (value >= 278.000000 && value <= 512.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 512.000000 && value <= 1014.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.2 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1014.000000 && value <= 1433.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.2 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1433.000000 && value <= 2361.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.2 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2361.000000 && value <= 4503.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.2 + size,
